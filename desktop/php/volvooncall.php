...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogic" style="display: none;">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation" class="active"><a href="#eqlogictab" aria-controls="home" role="tab" data-toggle="tab"><i class="fas fa-tachometer-alt"></i><span class="hidden-xs"> {{Voitures}}</span></a></li>
